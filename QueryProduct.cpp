...
const std::string SELECT_PRODUCT = "SELECT p.id, p.name, p.id_category, cat.name, p.id_company, com.name FROM product AS p, category AS cat, company AS com WHERE p.id_category=cat.id AND p.id_company=com.id";
